...
export const en: LocaleStrings = {
  ...
  time: {
    moment: 'a moment',
    microsecond: { singular: 'a microsecond', plural: 'microseconds', one: 'microsecond' },
    millisecond: { singular: 'a millisecond', plural: 'milliseconds', one: 'millisecond' },
    second: { singular: 'a second', plural: 'seconds', one: 'second' },
    minute: { singular: 'a minute', plural: 'minutes', one: 'minute' },
    hour: { singular: 'an hour', plural: 'hours', one: 'hour' },
    day: { singular: 'a day', plural: 'days', one: 'day' },
    week: { singular: 'a week', plural: 'weeks', one: 'week' },
    month: { singular: 'a month', plural: 'months', one: 'month' },
    year: { singular: 'a year', plural: 'years', one: 'year' },
    today: 'today',
    yesterday: 'yesterday',
    tomorrow: 'tomorrow',
    connector: 'and',
